namespace inf_system_airline_companies
{
    partial class about_form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Информационно-справочная система \"Авиатранспортные компании\"";
            ...
            this.label2.Text = "Разработчиком программы является студент второго курса факультета Прикладной мате" +
    "матики и информационных технологий - Степанов И.Е.";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Работа была выполнена под руководством Горелова С.В.";
            // 
            // about_form
            // 
